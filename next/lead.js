...
(() => {
  ...
  const FALLBACK = {
    ...
    kinds: {
      session:   { title: 'Book a strategy session', line: 'Sixty minutes with the strategists behind Stagwell. We arrive with your dashboard already open.', submit: 'Continue' },
      expert:    { title: 'Talk to an AI expert', line: 'A working conversation about the problem you’re facing — and which products in the Stagwell suite solve it.', submit: 'Continue' },
      workspace: { title: 'Request your full AI workspace', line: 'The whole Stagwell suite, pointed at your brand and running continuously. We provision in five working days.', submit: 'Continue' },
      ...
      callback:  { title: 'Stagwell will call you', line: 'A NewVoices agent will call within two minutes, already briefed on what you told the agent.', submit: 'Call me now' }
    }
  };
