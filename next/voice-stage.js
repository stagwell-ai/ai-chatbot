/* ═══════════════════════════════════════════════════════════════════════════
   ...
   never run ahead of, or behind, the voice.
     ...
     create(host, cfg) → { open, reveal, caption, assemble, close, destroy, state }
...
(function (root, factory) {
  ...
  function create(host, cfg) {
    ...
    return { open, reveal, caption, assemble, close, destroy, state: () => ({ phase, revealed: revealed.slice() }), _el: () => el };
  }

  return { create, icons: Object.keys(ICONS) };
});
