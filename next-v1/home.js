...
(function () {
  ...
  if (heroL && stack && thread && mini && miniInput) {
    ...
    const goLink = () => ({ href: '/next-v1/agent.html?autostart=1' + (state.problem ? '&q=' + encodeURIComponent(state.problem) : ''), label: 'See your snapshot' });
  ...
  /* ── the input: a tag puts its words in the field and nothing more. The
        ...
        GET carrying q and autostart=1 to /next-v1/agent. ───────────────────── */
