...
(function () {
  ...
  const internalHref = id => CAMPAIGN_PAGES[id] || '/next-v1/s/' + encodeURIComponent(id);
      ...
      <section class="prodhero">
        <div class="prodhero__in">
          ...
          <div class="prodhero__acts">
            <a class="btn btn--gold prodhero__cta" href="/next-v1">Find my fit in a conversation →</a>
      ...
      <section class="prodband">
        <div class="prodband__in">
          ...
          <div class="prodband__acts">
            ...
            <a class="btn btn--light" href="/next-v1">Start with the agent</a>
          </div>
        </div>
      </section>
